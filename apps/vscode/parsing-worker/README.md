...
> Note: Because this is an nx app, you will need to use `nx build vscode-parsing-worker --watch` to build this and live-reload on changes in order for changes to the parsing code to be used at runtime or during development.
