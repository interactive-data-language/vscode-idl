...
export const AUTO_TASK_GENERATION_TESTS: ITaskGenerationTests[] = [
  {
    ...
    tests: [
      {
        name: `from PRO`,
        file: `apps/test/idl/task-generation/envitasktest.pro`,
        type: 'envi',
      },
    ],
  },
    ...
    tests: [
      {
        ...
        file: `apps/test/idl/task-generation/empty_envi.pro`,
        type: 'envi',
      },
    ],
  },
  {
    ...
    tests: [
      {
        name: `from PRO`,
        file: `apps/test/idl/task-generation/idltasktest.pro`,
        type: 'idl',
      },
    ],
  },
  {
    ...
    tests: [
      {
        name: `because of missing PRO definition`,
        file: `apps/test/idl/task-generation/empty_idl.pro`,
        type: 'idl',
      },
    ],
  },
