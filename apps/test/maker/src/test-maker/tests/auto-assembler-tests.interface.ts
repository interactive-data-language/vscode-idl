...
export const AUTO_ASSEMBLER_TESTS: IAutoAssemblerTest[] = [
  ...
  {
    suiteName: `Verify number literal serialization`,
    fileName: `auto-doc.number-literals.spec.ts`,
    tests: [
      {
        name: `matches what we parsed`,
        code: [
          `;+`,
          `; :Arguments:`,
  ...
  {
    suiteName: `Verify we use return type`,
    fileName: `auto-doc.return-type.spec.ts`,
    tests: [
      {
        name: `for initial docs`,
        code: [
  ...
  {
    suiteName: `Automatically add docs`,
    fileName: `def-files.auto-doc.1.spec.ts`,
    tests: [
      {
        name: `procedures`,
        code: [
  ...
  {
    suiteName: `Verify hanging indent`,
    fileName: `format.hanging-indent.1.spec.ts`,
    tests: [
      {
        name: `works the right way when enabled`,
        code: [
      ...
      {
        name: `works the right way when disabled`,
        code: [
          `function myclass::mymethod, $`,
          `  a, b, c`,
          `  compile_opt idl2`,
  ...
  {
    suiteName: `Verify hanging indent`,
    fileName: `format.hanging-indent.2.spec.ts`,
    tests: [
      {
        name: `works the right way with max length`,
        code: [
          `function myclass::mymethod, $`,
          `  a, b, c`,
          `  compile_opt idl2`,
