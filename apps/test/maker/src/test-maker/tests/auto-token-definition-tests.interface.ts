...
export const AUTO_TOKEN_DEFINITION_TESTS: ITokenDefTests[] = [
    ...
    tests: [
      {
        ...
        files: [`apps/test/idl/token-def/call_function.pro`],
        position: [
          {
            line: 8,
            character: 18,
    ...
    tests: [
      {
        ...
        files: [
          ...
          `apps/test/idl/change-detection/dynamic/leap2.pro`,
          `apps/test/idl/change-detection/dynamic/leap.pro`,
          `apps/test/idl/change-detection/dynamic/leap3.pro`,
        ],
        position: [
          {
            line: 8,
    ...
    tests: [
      {
        name: `change detection with proper type`,
        files: [
          `apps/test/idl/change-detection/dynamic/use_leap.pro`,
          // purposely out of order
          `apps/test/idl/change-detection/dynamic/leap2.pro`,
          `apps/test/idl/change-detection/dynamic/leap.pro`,
          `apps/test/idl/change-detection/dynamic/leap3.pro`,
    ...
    tests: [
      {
        ...
        files: [
          `apps/test/idl/token-def/from_def.pro`,
  ...
  },
  {
    ...
    tests: [
      {
        name: `real`,
        files: [`apps/test/idl/token-def/all_cases.pro`],
        position: [
          {
            line: 58,
            character: 11,
  ...
  },
  {
    ...
    tests: [
      {
        name: `real`,
        files: [`apps/test/idl/token-def/include_test.pro`],
        position: [
          {
            line: 4,
            character: 7,
  ...
  },
  {
    ...
    tests: [
      {
        name: `real`,
        files: [`apps/test/idl/token-def/obj_destroy.pro`],
        position: [
          {
            line: 23,
            character: 6,
  ...
  },
  {
    ...
    tests: [
      {
        name: `real`,
        files: [`apps/test/idl/token-def/obj_new.pro`],
        position: [
          {
            line: 53,
            character: 12,
    ...
    tests: [
      {
        ...
        files: [
          `apps/test/idl/token-def/tasks.pro`,
          `apps/test/idl/token-def/atanomalydetection.task`,
        ],
        position: [
          {
            line: 2,
