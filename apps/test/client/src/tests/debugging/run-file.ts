...
const TO_RUN: { file: string; success: boolean }[] = [
   ...
   */
  {
    file: GetExtensionPath('apps/test/idl/client-e2e/debug/run-file/main.pro'),
    success: true,
  },
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/syntax_error.pro',
    ),
    success: false,
  },
  ...
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/procedure.pro',
    ),
    success: true,
  },
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/procedure_with_main.pro',
    ),
    success: true,
  },
  ...
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/function.pro',
    ),
    success: true,
  },
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/function_with_main.pro',
    ),
    success: true,
  },
  ...
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/name mismatch.pro',
    ),
    success: true,
  },
  ...
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/procedure_method.pro',
    ),
    success: false,
  },
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/procedure_method_with_main.pro',
    ),
    success: true,
  },
  ...
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/function_method.pro',
    ),
    success: false,
  },
  {
    file: GetExtensionPath(
      'apps/test/idl/client-e2e/debug/run-file/function_method_with_main.pro',
    ),
    success: true,
  },
];
