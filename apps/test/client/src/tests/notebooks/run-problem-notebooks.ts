...
export const RunProblemNotebooks: RunnerFunction = async (init) => {
  ...
  await RunNotebookAndCompareCells(
    GetExtensionPath(
      'apps/test/idl/client-e2e/notebooks/problems/on-stop.idlnb',
    ),
    [
      {
        idx: 0,
  ...
  await RunNotebookAndCompareCells(
    GetExtensionPath(
      'apps/test/idl/client-e2e/notebooks/problems/syntax-err1.idlnb',
    ),
    [
      {
        idx: 0,
  ...
  await RunNotebookAndCompareCells(
    GetExtensionPath(
      'apps/test/idl/client-e2e/notebooks/problems/syntax-err2.idlnb',
    ),
    [
      {
        idx: 0,
