...
export const NotebookCallStackDecorationsNoDecorations: RunnerFunction = async (
  ...
  await RunNotebookAndCheckCallStackDecorations(
    GetExtensionPath(
      'apps/test/idl/client-e2e/notebooks/decorations/no-decorations.1.idlnb',
    ),
    {},
  ...
  await RunNotebookAndCheckCallStackDecorations(
    GetExtensionPath(
      'apps/test/idl/client-e2e/notebooks/decorations/no-decorations.2.idlnb',
    ),
    {},
    init.notebooks.controller,
    init.decorations,
  ...
  await RunNotebookAndCheckCallStackDecorations(
    GetExtensionPath(
      'apps/test/idl/client-e2e/notebooks/decorations/no-decorations.3.idlnb',
    ),
    {},
    init.notebooks.controller,
    init.decorations,
  ...
  await RunNotebookAndCheckCallStackDecorations(
    GetExtensionPath(
      'apps/test/idl/client-e2e/notebooks/decorations/no-decorations.4.idlnb',
    ),
    {},
    init.notebooks.controller,
    init.decorations,
