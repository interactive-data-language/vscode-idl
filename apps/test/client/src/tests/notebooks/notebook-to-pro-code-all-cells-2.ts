...
export const NotebookToProCodeAllCells2: RunnerFunction = async (init) => {
  const nbUri = GetExtensionPath(
    'apps/test/idl/client-e2e/notebooks/notebook-to-pro-code/dl-training-example.idlnb',
  );

  const expectedUri = GetExtensionPath(
    'apps/test/idl/client-e2e/notebooks/notebook-to-pro-code/dl_training_example_output_all.pro',
  );
