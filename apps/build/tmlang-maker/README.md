...
And, as you make edits to the `resources/language/syntaxes/src/idl.tmLanguage.yaml` any changes will be live-reloaded and the plist file will be automatically updated for you.
