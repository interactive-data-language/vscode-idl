...
export const STRUCTURE_OVERRIDE: IStructureOverride = {
  envi: {
    ...
    properties: {
      ...
      data: {
        type: IDLTypeHelper.parseIDLType('ENVIDataCollection'),
      },
      preferences: {
        type: IDLTypeHelper.parseIDLType('ENVIPreferences'),
      },
      root_direction: {
        type: IDL_STRING_TYPE,
      },
      ...
      ui: {
        type: IDLTypeHelper.parseIDLType('ENVIUI | Null'),
      },
      uvalue: {
        type: IDL_ANY_TYPE,
      },
  ...
  httprequest: {
    ...
    properties: {
      appconnect_time: {
        ...
        direction: 'out',
        type: IDLTypeHelper.parseIDLType('Int'),
      ...
      content: {
        display: 'content',
        direction: 'out',
        type: IDLTypeHelper.parseIDLType('Array<Byte> | Byte'),
      ...
      headers: {
        display: 'headers',
        direction: 'out',
        type: IDLTypeHelper.parseIDLType('OrderedHash<any>'),
  ...
  idl_shape_entity: {
    ...
    properties: {
      attributes: {
        ...
        type: IDLTypeHelper.parseIDLType('Pointer<any>'),
      ...
      parts: {
        display: 'parts',
        direction: 'bidirectional',
        type: IDLTypeHelper.parseIDLType('Pointer<Array<Long>>'),
      ...
      vertices: {
        display: 'vertices',
        direction: 'bidirectional',
        type: IDLTypeHelper.parseIDLType('Pointer<Array<Double>>'),
