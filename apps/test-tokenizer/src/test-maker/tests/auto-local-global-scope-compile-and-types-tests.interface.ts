  ...
  [
    ...
    },
    {
      ...
      tests: [
        ...
        {
          name: 'ignore docs that are not immediately on the next line',
          code: [
            ``,
    ...
    {
      suiteName: `Types from`,
      fileName: `types.arrays.legacy.spec.ts`,
      tests: [
        {
          name: `array creation using brackets`,
          code: [
    ...
    {
      suiteName: `Types from`,
      fileName: `types.from-number-literals.spec.ts`,
      tests: [
        {
    ...
    {
      suiteName: `Cases to make sure we always merge literal types and generic types`,
      fileName: `types.literal.merge.1.spec.ts`,
      tests: [
        {
          name: 'for literal numbers',
          code: [
            `;+`,
            `; :Returns: 1 | 2 | Number`,
            `;-`,
    ...
    {
      suiteName: `Cases to make sure we always merge literal types and generic types`,
      fileName: `types.literal.merge.2.spec.ts`,
      tests: [
        {
          name: 'for literal strings',
          code: [
            ``,
            `;+`,
            `; :Returns: '1' | "2" | String`,
    ...
    {
      suiteName: `Cases to make sure we parse literal types`,
      fileName: `types.literal.strings.1.spec.ts`,
      tests: [
        {
          name: 'for literal strings',
          code: [
    ...
    {
      suiteName: `Cases to make sure we parse literal types`,
      fileName: `types.literal.numbers.1.spec.ts`,
      tests: [
        {
          name: 'for literal numbers',
          code: [
