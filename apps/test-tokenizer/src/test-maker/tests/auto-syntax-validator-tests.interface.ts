...
export const AUTO_SYNTAX_TESTS: IAutoSyntaxValidatorTest[] = [
  ...
  {
    suiteName: `Does not detect unknown tokens`,
    fileName: `code.7.unknown-token.regrression.spec.ts`,
    tests: [
      {
        name: `with case`,
        code: [
  ...
  {
    suiteName: `Check for known keywords`,
    fileName: `code.97.unknown-kw.exceptions4.spec.ts`,
    tests: [
      {
        name: `correctly with obj_destroy`,
        code: [
  ...
  {
    suiteName: `Logical predicate with and`,
  ...
  {
    suiteName: `Logical predicate with or`,
  ...
  {
    suiteName: `Logical predicate with not`,
  ...
  {
    suiteName: `Logical predicate with xor`,
    fileName: `code.113.logical-xor.spec.ts`,
    tests: [
      {
        name: `no problems`,
        code: [
