...
Resolved an issue with the auto-complete performance improvements where auto-complete would include character-by-character auto-completions for routines and structues. For example, if you created a function called `myplot`, you would get auto complete for `m`, `my`, `myp`, etc. depending on how fast your typed.
