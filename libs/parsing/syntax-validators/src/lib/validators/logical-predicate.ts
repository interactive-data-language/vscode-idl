...
PROBLEM_LOOKUP['and'] = IDL_PROBLEM_CODES.LOGICAL_PREDICATE_AND;
PROBLEM_LOOKUP['or'] = IDL_PROBLEM_CODES.LOGICAL_PREDICATE_OR;
PROBLEM_LOOKUP['not'] = IDL_PROBLEM_CODES.LOGICAL_PREDICATE_NOT;
PROBLEM_LOOKUP['xor'] = IDL_PROBLEM_CODES.LOGICAL_PREDICATE_XOR;
