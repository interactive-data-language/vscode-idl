 ...
 */
export const TYPE_ORDER_LOOKUP: { [key: string]: number } = {};
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.COMPLEX_NUMBER] = 15;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.COMPLEX_DOUBLE] = 14;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.COMPLEX_FLOAT] = 13;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.NUMBER] = 12;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.BIG_INTEGER] = 11;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.DOUBLE] = 10;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.FLOAT] = 9;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.UNSIGNED_LONG64] = 8;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.LONG64] = 7;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.UNSIGNED_LONG] = 6;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.LONG] = 5;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.UNSIGNED_INTEGER] = 4;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.INTEGER] = 3;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.BYTE] = 2;
TYPE_ORDER_LOOKUP[IDL_TYPE_LOOKUP.BOOLEAN] = 1;
