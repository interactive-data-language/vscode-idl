 ...
 */
export const IDL_DEF_FILE_PROBLEMS: { [key: number]: undefined } = {};

// set docs problems in our constant
IDL_PROBLEM_CODE_SHORTHAND_CODE_LOOKUP[
  IDL_PROBLEM_CODE_SHORTHAND_LOOKUP.IDL_DOCS
].forEach((prob) => {
  IDL_DEF_FILE_PROBLEMS[prob] = undefined;
});

// other problems that can be reported from docs
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_FUNCTION] = undefined;
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_FUNCTION_METHOD] = undefined;
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_PROCEDURE] = undefined;
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_PROCEDURE_METHOD] = undefined;
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_STRUCTURE] = undefined;
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_SYSTEM_VARIABLE] = undefined;

IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_ARG_VARIABLE_DEF] = undefined;
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_KEYWORD_DEF] = undefined;
IDL_DEF_FILE_PROBLEMS[IDL_PROBLEM_CODES.DUPLICATE_PROPERTY] = undefined;
