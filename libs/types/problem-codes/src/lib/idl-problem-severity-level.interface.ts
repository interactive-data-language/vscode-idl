...
IDL_PROBLEM_SEVERITY_LEVEL_MAP[IDL_PROBLEM_CODES.UNUSED_VARIABLE] =
  IDL_PROBLEM_SEVERITY_LOOKUP.WARNING;
IDL_PROBLEM_SEVERITY_LEVEL_MAP[IDL_PROBLEM_CODES.LOGICAL_PREDICATE_AND] =
  IDL_PROBLEM_SEVERITY_LOOKUP.WARNING;
IDL_PROBLEM_SEVERITY_LEVEL_MAP[IDL_PROBLEM_CODES.LOGICAL_PREDICATE_OR] =
  IDL_PROBLEM_SEVERITY_LOOKUP.WARNING;
IDL_PROBLEM_SEVERITY_LEVEL_MAP[IDL_PROBLEM_CODES.LOGICAL_PREDICATE_NOT] =
  IDL_PROBLEM_SEVERITY_LOOKUP.WARNING;
IDL_PROBLEM_SEVERITY_LEVEL_MAP[IDL_PROBLEM_CODES.LOGICAL_PREDICATE_XOR] =
  IDL_PROBLEM_SEVERITY_LOOKUP.WARNING;
