...
import { RunMCPTool_ManageIDLDebugger } from './tools/idl/run-mcp-tool-manage-idl-debugger';
import { RunMCPTool_QueryIDLSession } from './tools/idl/run-mcp-tool-query-idl-session';
...
export const RUN_MCP_TOOL_LOOKUP: {
  ...
  'manage-idl-debugger': RunMCPTool_ManageIDLDebugger,
  ...
  'query-idl-session': RunMCPTool_QueryIDLSession,
