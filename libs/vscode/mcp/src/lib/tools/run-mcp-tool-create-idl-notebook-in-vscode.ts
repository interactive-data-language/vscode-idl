import { RunMCPTool_CreateIDLNotebook } from '@idl/mcp/idl';
import {
 ...
 */
export async function RunMCPTool_CreateIDLNotebookInVSCode(
  id: string,
  ...
  const result = await RunMCPTool_CreateIDLNotebook(params);
