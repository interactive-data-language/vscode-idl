...
describe(`[auto generated] Types from`, () => {
  it(`[auto generated] ordered hashes`, async () => {
    // create index
          ...
          arg1: {
            ...
            meta: {
              ...
              type: [
                {
                  name: 'OrderedHash',
                  display: 'OrderedHash<Number | String>',
                  serialized: 'OrderedHash<Number | String>',
                  args: [
                    [
                      {
                        name: 'Number',
    ...
    const expectedGlobal: GlobalTokens = [
      {
        ...
        meta: {
          ...
          docs: '\n```idl\nordered_hashes, arg1, arg2, arg3, arg4, arg5, arg6\n```\n\n\n\n\n#### Arguments\n\n- **arg1**: in, required, OrderedHash<Number | String>\n\n  Placeholder docs for argument, keyword, or property\n\n- **arg2**: in, required, Array<Number>\n\n  Placeholder docs for argument, keyword, or property\n\n- **arg3**: in, required, Array<any>\n\n  Placeholder docs for argument, keyword, or property\n\n- **arg4**: in, required, Array<Byte>\n\n  Placeholder docs for argument, keyword, or property\n\n- **arg5**: in, required, Array<ENVIRaster>\n\n  Placeholder docs for argument, keyword, or property\n\n- **arg6**: in, required, any\n\n  Placeholder docs for argument, keyword, or property\n\n',
          docsLookup: { default: '' },
          display: 'ordered_hashes',
          kws: {},
          private: false,
          struct: [],
        },
