...
describe(`[auto generated] Regression tests`, () => {
  it(`[auto generated] for problems`, async () => {
    // create index
    ...
    // specify filepath
    const filepath = GetExtensionPath('idl/test/auto-complete/regression1.pro');

    // add file to index
    await index.indexFile(filepath);

    // define position
    const position_0: Position = { line: 2, character: 28 };
