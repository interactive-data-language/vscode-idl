    ...
    const expectedFound_0: CompletionItem[] = [
      ...
      },
      {
        ...
        documentation: {
          kind: 'markdown',
          value:
            'A 4-by-_N_ floating-point array that specifies the coefficients of the clipping planes to be applied to this object. The four coefficients for each clipping plane are of the form \\[A, B, C, D\\], where A_x_ \\+ B_y_ \\+ C_z_ \\+ D = 0\\. Portions of this object that fall in the half space A_x_ \\+ B_y_ \\+ C_z_ \\+ D > 0 will be clipped. By default, the value of this property is a scalar (-1) indicating that no clipping planes are to be applied.\n\n_Note:_ The clipping planes specified via this property are applied in addition to the near and far clipping planes associated with the IDLgrView in which this object appears.\n\n_Note:_ Clipping planes are applied in the data space of this object (prior to the application of any _x_, _y_, or _z_ coordinate conversion).\n\n_Note:_ To determine the maximum number of clipping planes supported by the device, use the MAX\\_NUM\\_CLIP\\_PLANES property of the GetDeviceInfo method for the IDLgrBuffer, IDLgrClipboard, IDLgrWindow, and IDLgrVRML objects.\n\n| **Property Type** | Floating-point array |               |                    |\n| ----------------- | -------------------- | ------------- | ------------------ |\n| **Name String**   | _not displayed_      |               |                    |\n| **Get:** Yes      | **Set:** Yes         | **Init:** Yes | **Registered:** No |',
        },
      },
      {
        label: 'color',
      ...
      },
      {
        ...
        documentation: {
          kind: 'markdown',
          value:
            'An integer value or an enumerated list item that indicates the style to be used to draw the surface. Valid values are:\n\n| Value | Property Sheet Value | Description                                                         |\n| ----- | -------------------- | ------------------------------------------------------------------- |\n| 0     | Points               | Points                                                              |\n| 1     | Wire mesh            | Wire mesh (the default)                                             |\n| 2     | Filled               | Filled                                                              |\n| 3     | RuledXZ              | RuledXZ                                                             |\n| 4     | RuledYZ              | RuledYZ                                                             |\n| 5     | Lego                 | Lego                                                                |\n| 6     | Lego filled          | Lego filled for outline or shaded and stacked histogram-style plots |\n\n_Note:_ Stitching effects may appear when combining an unfilled style (STYLE=0, 1, 3, 4, or 5) and hidden lines (HIDDEN\\_LINES=1). In such a case, missing lines may be caused by depth buffer resolution, limited depth offset support of the graphics card, or invisible parts of a surface occluding line visibility. \n\n| **Property Type** | ENUMLIST      |               |                     |\n| ----------------- | ------------- | ------------- | ------------------- |\n| **Name String**   | Surface style |               |                     |\n| **Get:** Yes      | **Set:** Yes  | **Init:** Yes | **Registered:** Yes |',
        },
      },
      {
        label: 'texture_coord',
    ...
    const expectedFound_0: CompletionItem[] = [
      ...
      },
      {
        ...
        documentation: {
          kind: 'markdown',
          value:
            'This property retrieves a reference to the [ENVIDataCollection](command:idl.docs.openLink?%7B%22link%22:%22IDL_DOCS/../Subsystems/envi/Content/ExtendCustomize/ENVIDataCollection/ENVIDataCollection.htm%22%7D) object, which is a collection of data objects currently available in the Data Manager.',
        },
      },
      {
        label: 'error',
      ...
      },
      {
        ...
        documentation: {
          kind: 'markdown',
          value:
            "Set this property to a string specifying a full path and filename for a log file that will contain any warnings or errors issued during execution of ENVI routines. Set this property to a null string (`''`) to turn off error logging. To add custom messages to the default content, use the [ENVI::LogMessage](command:idl.docs.openLink?%7B%22link%22:%22IDL_DOCS/../Subsystems/envi/Content/ExtendCustomize/ENVI%20Routine/ENVI%255F%255FLogMessage.htm%22%7D) method.\n\nErrors that occur through user interaction of ENVI (non-programmatically) are not written to this log file but are handled by the **[Enable System Logging](command:idl.docs.openLink?%7B%22link%22:%22IDL_DOCS/../Subsystems/envi/Content/Preferences.htm#EnableSystemLogging%22%7D)** preference.\n\nSee [Manage Errors](command:idl.docs.openLink?%7B%22link%22:%22IDL_DOCS/../Subsystems/envi/Content/ExtendCustomize/ProgrammingGuide/ErrorHandling.htm%22%7D) for more information on error handling in ENVI programming.",
        },
      },
      {
        label: 'preferences',
      ...
      },
      {
        ...
        documentation: {
          kind: 'markdown',
          value:
            'A string array with the names of all available [ENVITasks](command:idl.docs.openLink?%7B%22link%22:%22IDL_DOCS/../Subsystems/envi/Content/ExtendCustomize/ENVITasks/ENVITask.htm%22%7D).',
        },
      },
      {
        label: 'ui',
