...
describe(`[auto generated] Verify auto-complete in structures`, () => {
  it(`[auto generated] for properties, property completion, and normal property completion`, async () => {
    ...
    const expectedFound_2: CompletionItem[] = [
      ...
      {
        label: 'ENVIWorkflow::generateMetatask()',
        insertText: 'generateMetatask()',
        kind: 2,
        sortText: '03',
        detail: 'Function Method',
        command: { title: 'Cursor Adjust', command: 'cursorLeft' },
      ...
      {
        label: 'ENVIWorkflow::isFirstStep()',
        insertText: 'isFirstStep()',
        kind: 2,
        sortText: '03',
        detail: 'Function Method',
        command: { title: 'Cursor Adjust', command: 'cursorLeft' },
      ...
      {
        label: 'ENVIPointCloudProductsInfo::dehydrate()',
        insertText: 'dehydrate()',
        kind: 2,
        sortText: '03',
        detail: 'Function Method',
      ...
      {
        label: 'ENVIPointCloudProductsInfo::hydrate()',
        insertText: 'hydrate()',
        kind: 2,
        sortText: '03',
        detail: 'Function Method',
