...
describe(`[auto generated] Correctly return auto-complete from obj-destroy`, () => {
  it(`[auto generated] real`, async () => {
    ...
    // specify filepath
    const filepath = GetExtensionPath('idl/test/auto-complete/obj_destroy.pro');

    // add file to index
    await index.indexFile(filepath);

    // define position
    const position_0: Position = { line: 23, character: 21 };
