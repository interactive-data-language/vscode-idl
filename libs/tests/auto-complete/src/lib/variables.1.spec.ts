...
describe(`[auto generated] Correctly finds the right variables`, () => {
  it(`[auto generated] when we auto-complete`, async () => {
    ...
    // define position
    const position_0: Position = { line: 6, character: 10 };
    ...
    // define position
    const position_1: Position = { line: 9, character: 2 };
    ...
    const expectedFound_1: CompletionItem[] = [
      ...
      },
      {
        ...
        sortText: '01',
        detail: 'Variable',
        documentation: { kind: 'markdown', value: 'raster to process' },
      },
      {
        label: 'rois',
        kind: 6,
      ...
      },
      {
        ...
        sortText: '01',
        detail: 'Variable',
        documentation: { kind: 'markdown', value: 'get normalization stats' },
      },
      {
        label: 'trainingDataTask',
        kind: 6,
        sortText: '01',
        detail: 'Variable',
        documentation: {
          kind: 'markdown',
          value: 'get training data from ROIs and raster',
        },
      },
      {
        label: 'oobs',
