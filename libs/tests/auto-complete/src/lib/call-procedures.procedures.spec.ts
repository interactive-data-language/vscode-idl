...
describe(`[auto generated] Add names of procedures that we can auto-complete`, () => {
  it(`[auto generated] for all cases`, async () => {
    ...
    const expectedFound_1: CompletionItem[] = [
      ...
      { label: 'class_doit', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'ENVITime', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'ireset', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'cdf_attinq', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'cdf_lib_info', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'file_delete', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'dlm_load', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'hls', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'polar_contour', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'cdf_varput', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'hdf_an_end', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'annotate', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'get_lun', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'blas_axpy', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'asdf_write', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'imsl_sp_mvmul', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'igetproperty', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'iputdata', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'hdf_vd_get', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'file_copy', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'hdf_sd_getinfo', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'imap', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'read_ppm', kind: 3, sortText: '03', detail: 'Procedure' },
      {
      ...
      { label: 'polyfill', kind: 3, sortText: '03', detail: 'Procedure' },
      { label: 'h_eq_ct', kind: 3, sortText: '03', detail: 'Procedure' },
      {
