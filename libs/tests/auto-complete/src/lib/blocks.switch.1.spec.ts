...
describe(`[auto generated] Custom block auto-complete`, () => {
  it(`[auto generated] for switch`, async () => {
    // create index
    ...
    // define position
    const position_0: Position = { line: 9, character: 10 };
    ...
    // define position
    const position_1: Position = { line: 10, character: 11 };
    ...
    // define position
    const position_2: Position = { line: 11, character: 8 };
