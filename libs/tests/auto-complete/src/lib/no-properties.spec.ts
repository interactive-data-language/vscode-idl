...
describe(`[auto generated] Exclude properties`, () => {
  it(`[auto generated] for function methods`, async () => {
    ...
    // define position
    const position_0: Position = { line: 18, character: 12 };
  ...
  it(`[auto generated] for procedure method`, async () => {
    // create index
    const index = new IDLIndex(
      new LogManager({
        alert: () => {
    ...
    // define position
    const position_0: Position = { line: 23, character: 7 };
