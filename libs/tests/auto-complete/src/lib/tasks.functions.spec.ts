...
describe(`[auto generated] Task auto complete`, () => {
  it(`[auto generated] to make sure they look nice`, async () => {
    ...
    const expectedFound_0: CompletionItem[] = [
      ...
      {
        label: "ENVITask('ReprojectVector')",
        insertText: "ENVITask('ReprojectVector')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('FLAASH')",
        insertText: "ENVITask('FLAASH')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('DownloadOSMVectors')",
        insertText: "ENVITask('DownloadOSMVectors')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('CalculateGridDefinitionFromRasterUnion')",
        insertText: "ENVITask('CalculateGridDefinitionFromRasterUnion')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('KuanAdaptiveFilter')",
        insertText: "ENVITask('KuanAdaptiveFilter')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('RadarBackscatter')",
        insertText: "ENVITask('RadarBackscatter')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('PixelPurityIndex')",
        insertText: "ENVITask('PixelPurityIndex')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('VideoToRasterSeries')",
        insertText: "ENVITask('VideoToRasterSeries')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('GrayscaleMorphologicalFilter')",
        insertText: "ENVITask('GrayscaleMorphologicalFilter')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('ImageThresholdToROI')",
        insertText: "ENVITask('ImageThresholdToROI')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      {
        label: "ENVITask('ExtractGeoJSONFromFile')",
        insertText: "ENVITask('ExtractGeoJSONFromFile')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
      ...
      {
        label: "ENVITask('BufferZone')",
        insertText: "ENVITask('BufferZone')",
        kind: 3,
        sortText: '03',
        detail: 'Function',
      },
