...
describe(`[auto generated] Verify types being used for`, () => {
  it(`[auto generated] properties`, async () => {
    ...
    // define position
    const position_0: Position = { line: 16, character: 15 };
    ...
    // define position
    const position_1: Position = { line: 19, character: 21 };
    ...
    const expectedFound_1: CompletionItem[] = [
      {
        ...
        kind: 5,
        sortText: '02',
        detail: 'Property of ENVIRasterMetadata',
        documentation: {
          kind: 'markdown',
          value: 'A long integer that represents the number of available tags.',
        },
      },
      {
        label: 'tags',
      ...
      {
        label: 'ENVIRasterMetadata::dehydrate()',
        insertText: 'dehydrate()',
        kind: 2,
        sortText: '03',
        detail: 'Function Method',
      ...
      {
        label: 'ENVIRasterMetadata::hasTag()',
        insertText: 'hasTag()',
        kind: 2,
        sortText: '03',
        detail: 'Function Method',
      ...
      {
        label: 'ENVIRasterMetadata::hydrate()',
        insertText: 'hydrate()',
        kind: 2,
        sortText: '03',
        detail: 'Function Method',
    ...
    // define position
    const position_2: Position = { line: 19, character: 21 };
