...
describe(`[auto generated] Send procedure tokens`, () => {
  it(`[auto generated] in name`, async () => {
    // create index
    ...
    // define position
    const position_0: Position = { line: 4, character: 2 };
  ...
  it(`[auto generated] in name2`, async () => {
    // create index
    const index = new IDLIndex(
      new LogManager({
        alert: () => {
    ...
    // define position
    const position_0: Position = { line: 10, character: 5 };
