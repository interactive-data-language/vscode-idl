...
describe(`[auto generated] Detects when docs are not left-aligned as expected`, () => {
  ...
  it(`[auto generated] problems in params/keywords for def`, async () => {
    // create index
    const index = new IDLIndex(
      new LogManager({
        alert: () => {
  ...
  it(`[auto generated] problems in other blocks for def`, async () => {
    // create index
    const index = new IDLIndex(
      new LogManager({
        alert: () => {
  ...
  it(`[auto generated] problems in variables for def blocks`, async () => {
    // create index
    const index = new IDLIndex(
      new LogManager({
        alert: () => {
