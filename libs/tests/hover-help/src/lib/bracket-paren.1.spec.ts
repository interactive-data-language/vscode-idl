...
describe(`[auto generated] Correctly provides hover help for`, () => {
  it(`[auto generated] things after brackets and parentheses`, async () => {
    ...
    const expectedFound_2: string[] = [
      '#### [IDL_String::contains](https://www.nv5geospatialsoftware.com/docs/IDL_String.html#kanchor3842)',
      '',
      '```idl',
      'result = object.contains( [ substring ], [ /fold_case ])',
      '```',
      '',
    ...
    const expectedFound_5: string[] = [
      ...
      '',
      '```idl',
      'object.save, [ filename ], [ antialias = any ], [ /append ], [ /bit_depth ], [ bitmap = any ], [ border = any ], [ /centimeters ], [ close = any ], [ /cmyk ], [ /compression ], [ height = any ], [ /landscape ], [ /memory ], [ page_size = any ], [ resolution = any ], [ /reversible ], [ transparent = any ], [ width = any ], [ xmargin = any ], [ ymargin = any ]',
      '```',
      '',
      ...
      '  ',
      '  **Note:** If the APPEND keyword was used in the previous call to the Save method, the _Filename_ will be ignored.',
      '',
      '',
      '#### Keywords',
      '',
