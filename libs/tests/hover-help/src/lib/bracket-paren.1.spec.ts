...
describe(`[auto generated] Correctly provides hover help for`, () => {
  it(`[auto generated] things after brackets and parentheses`, async () => {
    ...
    const filepath = GetExtensionPath(
      'apps/test/idl/hover-help/bracket_paren.pro',
    );
    ...
    const expectedFound_2: string[] = [
      '[Online Docs](https://www.nv5geospatialsoftware.com/docs/IDL_String.html#kanchor4397) | [Open Examples in Notebook](command:idl.notebooks.helpAsNotebook?%7B%22type%22:%22fm%22,%22name%22:%22IDL_String::contains%22%7D)',
      '',
      '```idl',
      ';+',
      '; :Returns: any',
    ...
    const expectedFound_5: string[] = [
      ...
      '',
      '    Set this keyword to the output resolution (in dots per inch) to use when saving the window to an image or bitmap file format. If this keyword is not supplied, a default value of 600 DPI is used. The maximum output dimensions are 16384 x 16384\\. If the output dimensions are larger than these values, the resolution will be automatically reduced. This keyword is ignored if the output is in vector format (BITMAP=0).',
      '',
