...
describe(`[auto generated] Correctly provide hover help for`, () => {
  it(`[auto generated] function method`, async () => {
    ...
    const expectedFound_0: string[] = [
      '[Online Docs](https://www.nv5geospatialsoftware.com/docs/enviRaster__GetData.html) | [Open in Notebook](command:idl.notebooks.helpAsNotebook?%7B%22type%22:%22fm%22,%22name%22:%22ENVIRaster::getData%22%7D)',
      '',
      '```idl',
      ...
      '    ',
      '    **Note:** Big ROIs will return a large amount of data. To avoid returning too much data in a single read, see the second code example in [How do I process the pixels within an ROI?](https://www.nv5geospatialsoftware.com/docs/ProgrammingGuideFAQ.html#How6) in the ENVI API Programming Guide for an alternative way to extract ROI data.',
      '',
  ...
  it(`[auto generated] procedure methods`, async () => {
    ...
    // define expected token we extract
    const expectedFound_0: string[] = [
      '[Online Docs](https://www.nv5geospatialsoftware.com/docs/enviRaster__Save.html) | [Open in Notebook](command:idl.notebooks.helpAsNotebook?%7B%22type%22:%22pm%22,%22name%22:%22ENVIRaster::save%22%7D)',
      '',
      '```idl',
      'ENVIRaster.save, $',
      ' [ error = String ], $',
      ...
      '',
      'Saving an ENVIRaster overwrites any associated auxiliary files such as [pyramid files](https://www.nv5geospatialsoftware.com/docs/BackgroundPyramids.html) (`.enp`) that are automatically created.',
      '',
      '#### Keywords',
      '',
      '- **error**: out, optional, String',
