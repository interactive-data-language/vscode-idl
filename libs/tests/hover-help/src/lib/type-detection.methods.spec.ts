...
describe(`[auto generated] Correctly provide hover help for`, () => {
  it(`[auto generated] function method`, async () => {
    ...
    const expectedFound_0: string[] = [
      ...
      '    ',
      '    _Note:_ Big ROIs will return a large amount of data. To avoid returning too much data in a single read, see the second code example in [How do I process the pixels within an ROI?](https://www.nv5geospatialsoftware.com/docs/ProgrammingGuideFAQ.html#How6) for an alternative way to extract ROI data.',
      '',
