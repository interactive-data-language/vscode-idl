...
describe(`[auto generated] Correctly does not provide hover help`, () => {
  it(`[auto generated] for end tokens but does for the beginning`, async () => {
    ...
    const expectedFound_0: string[] = [
      ...
      '  ```',
      '  ',
      '  Tokens in the _Format_ string represent values of the LINESTYLE, COLOR, THICK, and SYMBOL properties. From one to four tokens can be present, and the tokens may be in any order. Tokens are case sensitive. For more information about the syntax of the _Format_ argument, see [Formatting IDL Graphics Symbols and Lines](command:idl.docs.openLink?%7B%22link%22:%22IDL_DOCS/../Subsystems/idl/Content/IDL%20Graphics/FormattingSymsAndLines.htm%22%7D).',
      '',
      ...
      '',
      '- **drag_quality**: bidirectional, optional, Boolean',
      '',
