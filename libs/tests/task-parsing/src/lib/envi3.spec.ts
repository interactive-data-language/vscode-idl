...
describe(`[auto generated] Correctly parse task file`, () => {
  it(`[auto generated] envi`, async () => {
    ...
    const filepath = GetExtensionPath(
      'apps/test/idl/task-parsing/PointCloudFeatureExtraction.task',
    );
    ...
    const expected: IGlobalsToTrack = {
      function: {
        ...
        meta: {
          ...
          source: 'user',
          docs: "\nThis task extracts features from point cloud data (buildings, trees, powerlines) and can produce a DEM, DSM, orthophoto, TIN, classified point cloud and 3D viewer database.\n\n### Syntax\n\n```idl\n;+\n; :Returns: ENVITask<PointCloudFeatureExtraction>\n;-\nmyTask = ENVITask('PointCloudFeatureExtraction')\n\n; set input parameters\nmyTask.input_point_cloud = value\nmyTask.spatialref = value\nmyTask.general_clip_min_height = value\nmyTask.general_clip_max_height = value\nmyTask.general_max_points_density = value\nmyTask.general_points_density_units = value\nmyTask.number_of_cores = value\nmyTask.save_parameters = value\nmyTask.products_location = value\nmyTask.buildings_generate = value\nmyTask.buildings_use_box_models = value\nmyTask.buildings_box_models_type = value\nmyTask.buildings_minimum_area = value\nmyTask.buildings_near_ground_filter_width = value\nmyTask.buildings_plane_surface_tolerance = value\nmyTask.buildings_points_in_range = value\nmyTask.buildings_format = value\nmyTask.buildings_uri = value\nmyTask.dem_contours_generate = value\nmyTask.dem_contours_lines_spacing = value\nmyTask.dem_contours_format = value\nmyTask.dem_contours_uri = value\nmyTask.dem_generate = value\nmyTask.dem_filter_database_edges = value\nmyTask.dem_grid_resolution = value\nmyTask.dem_constant_height_offset = value\nmyTask.dem_near_terrain_classification = value\nmyTask.dem_variable_sensitivity_algorithm = value\nmyTask.dem_sensitivity = value\nmyTask.dem_filter_lower_points = value\nmyTask.dem_format = value\nmyTask.dem_uri = value\nmyTask.dem_tin_generate = value\nmyTask.dem_tin_max_error = value\nmyTask.dem_tin_max_polygon_density = value\nmyTask.dem_tin_format = value\nmyTask.dem_tin_uri = value\nmyTask.dsm_generate = value\nmyTask.dsm_use_powerlines_points = value\nmyTask.dsm_grid_resolution = value\nmyTask.dsm_format = value\nmyTask.dsm_uri = value\nmyTask.filtered_pointcloud_generate = value\nmyTask.filtered_pointcloud_separate_by_class = value\nmyTask.filtered_pointcloud_size_limit = value\nmyTask.filtered_pointcloud_format = value\nmyTask.filtered_pointcloud_uri = value\nmyTask.orthophoto_generate = value\nmyTask.orthophoto_intensity_range_min = value\nmyTask.orthophoto_intensity_range_max = value\nmyTask.orthophoto_resolution = value\nmyTask.orthophoto_format = value\nmyTask.orthophoto_uri = value\nmyTask.powerlines_generate = value\nmyTask.powerlines_filter_by_min_joined_length = value\nmyTask.powerlines_filter_trees_below_powerlines = value\nmyTask.powerlines_search_wide = value\nmyTask.powerlines_search_lowkv = value\nmyTask.powerlines_min_height = value\nmyTask.powerlines_min_joined_length = value\nmyTask.powerlines_min_length = value\nmyTask.powerlines_format = value\nmyTask.powerlines_uri = value\nmyTask.powerpoles_detect = value\nmyTask.powerpoles_search_additional = value\nmyTask.powerpoles_class_extend_top = value\nmyTask.powerpoles_class_radius_low = value\nmyTask.powerpoles_extend_wires_distance = value\nmyTask.powerpoles_max_radius_top = value\nmyTask.powerpoles_location_file = value\nmyTask.trees_generate = value\nmyTask.trees_min_height = value\nmyTask.trees_max_height = value\nmyTask.trees_min_radius = value\nmyTask.trees_max_radius = value\nmyTask.trees_format = value\nmyTask.trees_uri = value\n\n; run the task\nmyTask.execute\n\n; get output parameters\noutput_products_info = myTask.output_products_info\n\n```\n\n\n### Input Parameters\n\n- **input_point_cloud**: ENVIPointCloud\n\n  Specify an ENVIPointCloud object on which to perform feature extraction.\n\n- **spatialref**: ENVIPointCloudSpatialRef\n\n  An ENVIPointCloudSpatialRef object that specifies the desired coordinate system of the generated products. If this property is not set, the default of UTM WGS84 will be used.\n\n- **general_clip_min_height**: Float\n\n  The minimum height extent of the source dataset in which processing will occur.\n\n- **general_clip_max_height**: Float\n\n  The maximum height extent of the source dataset in which processing will occur.\n\n- **general_max_points_density**: Float\n\n  This parameter limits the processed number of points. The limit is applied by taking only some of the points per block of data; a single block's dimensions are 32x32 meters. Limiting the density shortens the processing time of the buildings and power line detection algorithms.\n\n- **general_points_density_units**: 0 | 1\n\n  The units of the maximum points density. 0: points per square meter, 1: ground sample distance in meters.\n\n- **number_of_cores**: ULong\n\n  The number of cores used for product processing. The default value is zero, which indicates that all available cores will be used for processing. If a value larger than the number of available cores is specified, then the maximum number of available cores will be used.\n\n- **save_parameters**: 0 | 1\n\n  Sets whether to save the parameters with the data (in the project) when Execute() is called. If the parameters are saved the next time the data is opened and set in INPUT_POINT_CLOUD, calling ENVITask::Validate() or ENVITask::Execute() will restore the saved parameters (but will not overwrite any parameters set on the ENVITask). 0: Do not save. 1: Save.\n\n- **products_location**: String\n\n  The name of the output folder to which the associated product files will be written. This location is a subfolder of the main project folder.\n\n- **buildings_generate**: 0 | 1\n\n  0: Do not generate. 1: Generate.\n\n- **buildings_use_box_models**: 0 | 1\n\n  0: Do not use box models. 1: Use box models. This stops the algorithm from dividing buildings into sub-surfaces, and leaves them as flat roof bounding contours. The classification stays the same, but only one contour is generated at the requested height with the options set using the BUILDINGS_BOX_MODELS_TYPE parameter.\n\n- **buildings_box_models_type**: 0 | 1 | 2\n\n  Sets the roof contour height. 0: Height at Average Roof. The roof contour is set at the average height of the roof. 1: Height at Bottom Roof. The roof contour is set at the lowest point of the roof. 2: Height at Top Roof. The roof contour is set at the highest point of the roof.\n\n- **buildings_minimum_area**: Float\n\n  Surfaces with an area smaller than this are filtered out from the building list. Units: square meters.\n\n- **buildings_near_ground_filter_width**: Float\n\n  After filtering by BUILDINGS_MINIMUM_AREA, objects less than 5 meters above the ground with a side smaller than this filter width (default 300 centimeters) are not classified as buildings. This is useful for preventing buses, trucks, train cars, and so forth from being classified as buildings. Units: centimeters.\n\n- **buildings_plane_surface_tolerance**: Float\n\n  This parameter is the allowed vertical tolerance for searching for the surface in the neighboring points. Range: greater than or equal to 15.0 and less than or equal to 60.0. Units: centimeters.\n\n- **buildings_points_in_range**: Float\n\n  Normally this should be left at 0, which is the same as Auto in the user interface. However, if you have low density data (1 point per m2 or lower), large buildings such as hangars or warehouses may not be classified as buildings. Increasing this value to 1.2 or 1.4 will help detect them, but runs the risk of also identifying trees as buildings. Range: greater than or equal to 0.5 and less than or equal to 1.4. Units: meters.\n\n- **buildings_format**: 'dxf' | 'shp' | 'dae_1.4' | 'dae_1.5' | 'kml' | 'kmz'\n\n  A string value that specifies the file format to write buildings to: dxf, shp, dae_1.4, dae_1.5, kml or kmz.\n\n- **buildings_uri**: String\n\n  A string value specifying the filename for the buildings product.\n\n- **dem_contours_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **dem_contours_lines_spacing**: Float\n\n  This is the vertical spacing between height contour lines. This step is done after the DEM grid is generated; therefore, it does not affect the DEM grid generation. Range: greater than or equal to 50 and less than or equal to 1000. Units: centimeters.\n\n- **dem_contours_format**: 'dxf' | 'shp'\n\n  A string value that specifies the file format to write DEM contours to: dxf or shp.\n\n- **dem_contours_uri**: String\n\n  A string value specifying the filename for the DEM contours product.\n\n- **dem_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **dem_filter_database_edges**: 0 | 1\n\n  In some types of terrain, for example forested areas with trees at the edge of the dataset, the algorithms of the DEM grid generation do not detect the edges of the database well. 0: Process the edge of the database. 1: Do not process the edge of the database. The points that lie within an area up to 16 meters from the edges of the dataset are classified as unprocessed.\n\n- **dem_grid_resolution**: ULong\n\n  The grid resolution range allows selection of 50 to 1000 centimeters per pixel. Internally a 50 cm or 100 cm grid resolution is used and sub-sampled to 200-1000 cm if selected. The 50 cm grid tunes the DEM extraction algorithms to be more sensitive at some points, and requires higher density data. If the project density is lower than 4 points / m2, selecting the 50 cm grid will not result in better resolution of the DEM and the amount of time to create the DEM will increase. Range: Greater than or equal to 50 and less than or equal to 1000. Units: centimeters. \n\n- **dem_constant_height_offset**: Float\n\n  In noisy datasets the elevation of the DEM may be slightly offset due to inaccurate points above and below the ground. If this happens you can shift the terrain grid up or down. A positive number will move the DEM up, and a negative number will move the DEM down.\n\n- **dem_near_terrain_classification**: Float\n\n  When set at 50 (the default value), a point is considered to be a terrain classified point if it is within 50cm of the grid. You can select to have a near terrain classification between 5cm and 50cm. As an example, if this parameter is set to 20cm, points with a distance of 0 to 20cm from the grid are classified as terrain points, and points with a distance of 20 to 50cm are classified as near terrain points. Classifying points as near terrain is useful to catch low objects that are neither part of the terrain, nor are they buildings, trees or powerlines. For example: low vegetation, cars, buses, etc. could all be classified as near terrain objects. Range: greater than or equal to 15 and less than or equal to 50. Units: centimeters.\n\n- **dem_variable_sensitivity_algorithm**: 0 | 1\n\n  0: Disabled 1: Enable variable sensitivity algorithm. This algorithm works best in low-density forest areas and areas with large gaps between points. However, this algorithm has difficulty with identifying large buildings.\n\n- **dem_sensitivity**: Float\n\n  Use when DEM_VARIABLE_SENSITIVITY_ALGORITHM is enabled. The higher the sensitivity, the better it works with higher frequency terrain, but also it tends to extract buildings from points that should be identified as terrain. Valid range is 1 (low) to 300 (high).\n\n- **dem_filter_lower_points**: 0 | 3 | 10\n\n  0 : Do Not Filter. Disables filtering of points that are lower than the terrain. 3 : Urban Area Filtering. The area is divided to the grid resolution. For each cell in the grid, the list of points is put into a histogram and examined. Points are sorted by height, and the median point and standard deviation are found. Points that are below a multiplier of the standard deviation from the median are filtered out. If the standard deviation is too large, gaps are also counted in the histogram for better filtering. Urban areas have more false points that needed to be filtered. If you specify rural filtering in an urban area, some of the false points will not be detected. 10: Rural Area Filtering. Processing is done as it is in Urban Area Filtering. If you specify urban filtering in a rural area, the filtering may be too aggressive, and some good terrain points in forest areas may be filtered out resulting in bumps under trees.\n\n- **dem_format**: 'img' | 'surfer_ascii' | 'surfer_v6' | 'usgs_ascii' | 'xyz_ascii' | 'arcinfo_ascii' | 'geotiff' | 'envi'\n\n  A string value that specifies the file format to write the DEM to: 'img' - Erdas Elevation (Erdas Imagine IMG format with elevation data), 'surfer_ascii' - Surfer ASCII Grid, 'surfer_v6' - Surfer Binary Grid v6, 'usgs_ascii' - USGS ASCII DEM format, 'xyz_ascii' - XYZ ASCII Grid file, 'arcinfo_ascii' - Arc Info ASCII Grid format, 'geotiff' - GeoTIFF, 'envi' - ENVI format.\n\n- **dem_uri**: String\n\n  A string value specifying the filename for the DEM product.\n\n- **dem_tin_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **dem_tin_max_error**: Float\n\n  The maximum permitted vertical distance between a triangle and the actual terrain. This distance between the TIN and the actual terrain introduces errors into the TIN mesh. Reducing the Maximum Error value will result in a more accurate TIN at the expense of increased triangle count. A combination of this value and DEM_TIN_MAX_POLYGON_DENSITY will affect the TIN representation of the ground. TIN production does not affect the DEM grid production algorithm. The TIN production uses only the points classified as terrain. Reducing the value of the Near Terrain Classification parameter results in reducing the number of points that are classified as terrain, thereby reducing both the time for TIN generation and the size of the TIN generated. Units: centimeters.\n\n- **dem_tin_max_polygon_density**: Float\n\n  When producing TIN, this is the maximum number of triangles that will be produced in a 100 x 100 meter area. It may not be possible to achieve the terrain TIN maximum error if this polygon density parameter is set too low.\n\n- **dem_tin_format**: 'dxf' | 'shp'\n\n  A string value that specifies the file format to write the TIN to: dxf or shp.\n\n- **dem_tin_uri**: String\n\n  A string value specifying the filename for the DEM TIN product.\n\n- **dsm_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **dsm_use_powerlines_points**: 0 | 1\n\n  Specifies whether power lines and cables will be part of the DSM. Valid values are 0: Do not include, 1: Include.\n\n- **dsm_grid_resolution**: ULong\n\n  This setting specifies the resolution of the DSM grid. Range: Greater than or equal to 5 and less than or equal to 1000. Units: centimeters.\n\n- **dsm_format**: 'img' | 'surfer_ascii' | 'surfer_v6' | 'usgs_ascii' | 'xyz_ascii' | 'arcinfo_ascii' | 'geotiff' | 'envi'\n\n  A string value that specifies the file format to write the DSM to: 'img' - Erdas Elevation (Erdas Imagine IMG format with elevation data), 'surfer_ascii' - Surfer ASCII Grid, 'surfer_v6' - Surfer Binary Grid v6, 'usgs_ascii' - USGS ASCII DEM format, 'xyz_ascii' - XYZ ASCII Grid file, 'arcinfo_ascii' - Arc Info ASCII Grid format, 'geotiff' - GeoTIFF, 'envi' - ENVI format.\n\n- **dsm_uri**: String\n\n  A string value specifying the filename for the DSM product.\n\n- **filtered_pointcloud_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **filtered_pointcloud_separate_by_class**: 0 | 1\n\n  Specifies whether to separate the generated point cloud datasets, each containing data from an individual class.. 0: Do not separate, 1: Separate.\n\n- **filtered_pointcloud_size_limit**: Float\n\n  Set this to limit the size (Kb) of each of the generated point cloud files. If the value specified is less than 10000 (10MB), a value of 10000 will be used.\n\n- **filtered_pointcloud_format**: 'txt' | 'las' | 'bin'\n\n  A string value that specifies the file format to write the pointclouds to: txt, las or bin.\n\n- **filtered_pointcloud_uri**: String\n\n  A string value specifying the base file name for the filtered point cloud product. This name can have the following formats: base_filename_unclassified_000.las or base_filename_product_000.las (ex. pc_trees_000.las).\n\n- **orthophoto_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **orthophoto_intensity_range_min**: Float\n\n  All points with intensity lower than this value appear black. Use the default value (0) unless you see that the file is all or mostly white, in which case increase the value.\n\n- **orthophoto_intensity_range_max**: Float\n\n  All points with intensity higher than this value appear white. Use the default value (255) unless you see that the file is all or mostly black, in which case decrease the value.\n\n- **orthophoto_resolution**: ULong\n\n  This parameter specifies the resolution of the generated orthophoto. Range: greater than or equal to 25 and less than or equal to 800. Units: centimeters.\n\n- **orthophoto_format**: 'geotiff' | 'jpg' | 'png' | 'img' | 'bmp' | 'envi'\n\n  A string value that specifies the file format to write the orthophoto to: geotiff, jpg, png, img, bmp, or envi.\n\n- **orthophoto_uri**: String\n\n  A string specifying the filename for the orthophoto product.\n\n- **powerlines_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **powerlines_filter_by_min_joined_length**: 0 | 1\n\n  0: Do not filter powerlines by minimum joined length. 1: Filter powerlines by minimum joined length.\n\n- **powerlines_filter_trees_below_powerlines**: 0 | 1\n\n  0: Do not filter trees below powerlines. 1: Filter trees below powerlines. Sometimes trees considerably below powerlines may be incorrectly extended up to the powerlines. Filtering trees below powerlines attempts to vertically separate tree and powerline points, but this can sometimes incorrectly remove the entire tree.\n\n- **powerlines_search_wide**: 0 | 1\n\n  0: Do not get one line for triple conductors attached together in transmission lines. 1: Get one line for triple conductors attached together in transmission lines. Do not use this parameter and POWERLINES_SEARCH_LOWKV together.\n\n- **powerlines_search_lowkv**: 0 | 1\n\n  0: Do not search for low kilo volt power lines that are close to each other. 1: Search for low kilo volt power lines that are close to each other. Do not use this parameter and POWERLINES_SEARCH_WIDE together.\n\n- **powerlines_min_height**: Float\n\n  The minimum height of points from the ground at which to detect power lines. Units: meters.\n\n- **powerlines_min_joined_length**: Float\n\n  The Min. length threshold for joined power lines. Joined power lines shorter than this value will not be detected. Units: meters.\n\n- **powerlines_min_length**: Float\n\n  The minimum length threshold for power lines. Power lines shorter than this value will not be detected. Units: meters.\n\n- **powerlines_format**: 'dxf' | 'shp'\n\n  A string value that specifies the file format to write the powerlines to: dxf or shp.\n\n- **powerlines_uri**: String\n\n  The filename for the power lines product.\n\n- **powerpoles_detect**: 0 | 1\n\n  0: Do not generate power pole output. 1: Process power poles by searching, or by using the imported power poles locations reference list. Power poles are searched for by looking for attachment points where two power lines have a shared point. After identifying these shared points, the algorithm searches for a cluster of points with a shared angle range of lines extending from the shared points.\n\n- **powerpoles_search_additional**: 0 | 1\n\n  The power poles can be imported from a file using the POWERPOLES_LOCATION_FILE property. If a list of points was imported, set this to 1 to enable a search of additional power poles. If not enabled, only the imported power poles will be processed.\n\n- **powerpoles_class_extend_top**: Float\n\n  See POWERPOLES_CLASS_RADIUS_LOW. The classification of the top part of the power pole is done by the width of the power poles arms. If a wider radius is needed, use this parameter to extend it. Units: meters.\n\n- **powerpoles_class_radius_low**: Float\n\n  If the radius of the power pole is known, set the parameter to the known radius of the base (lower half). For large pylons if this parameter is not increased high enough not all of the points on the pylon will be classified as power pole. Units: meters.\n\n- **powerpoles_extend_wires_distance**: Float\n\n  Sets the maximum gap to be corrected. Capability is provided to bridge gaps in the line from the end of the detected line to the next power pole. Units: meters.\n\n- **powerpoles_max_radius_top**: Float\n\n  A float value indicating the maximum radius of the pole's arm. Units: meters.\n\n- **powerpoles_location_file**: String\n\n  A string containing the file name of the power pole locations file to import.\n\n- **trees_generate**: 0 | 1\n\n  0: Do not generate, 1: Generate.\n\n- **trees_min_height**: Float\n\n  The minimum height of trees in the project. Points having characteristic trees dispersal will be classified as trees. Units: centimeters.\n\n- **trees_max_height**: Float\n\n  The maximum height of trees in the project. Higher points will not be classified as trees. This avoids items such as cranes being classified as trees. Units: centimeters.\n\n- **trees_min_radius**: Float\n\n  The minimum radius of trees in the project. This avoids items such as lampposts being classified as trees. Units: centimeters.\n\n- **trees_max_radius**: Float\n\n  The maximum radius of trees in the project. Units: centimeters.\n\n- **trees_format**: 'csv' | 'shp'\n\n  A string value that specifies the file format to write the trees to: csv or shp.\n\n- **trees_uri**: String\n\n  The filename for the trees product.\n\n\n\n### Output Parameters\n\n- **output_products_info**: ENVIPointCloudProductsInfo\n\n  An object reference to an instance of enviPointCloudProductsInfo containing paths to all the generated files.\n\n",
          private: false,
          returns: [
            {
              name: 'envipointcloudfeatureextractiontask',
      ...
      structure: {
        ...
        meta: {
          display: 'ENVIPointCloudFeatureExtractionTask',
          readableName: 'Point Cloud Feature Extraction',
          source: 'user',
          ...
          props: {
            input_point_cloud: {
              ...
              type: [
                {
                  name: 'ENVIPointCloud',
                  display: 'ENVIPointCloud',
                  serialized: 'ENVIPointCloud',
                  args: [],
                  meta: {},
                },
              ],
