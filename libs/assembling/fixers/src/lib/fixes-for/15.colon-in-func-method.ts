...
import { CallFunctionMethodToken, TOKEN_NAMES } from '@idl/tokenizer';
 ...
 */
type RoutineTokens = CallFunctionMethodToken;

/**
 * Tokens to check for too many return args
 */
const TOKENS: RoutineTokens[] = [TOKEN_NAMES.CALL_FUNCTION_METHOD];
