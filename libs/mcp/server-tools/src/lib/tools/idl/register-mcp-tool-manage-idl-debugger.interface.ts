export const MANAGE_IDL_DEBUGGER_DESCRIPTION = `
Manages the IDL debugger session — set/clear breakpoints, step through code, and inspect the call stack.
...
- "get-stack": Get the current call stack (traceback).
