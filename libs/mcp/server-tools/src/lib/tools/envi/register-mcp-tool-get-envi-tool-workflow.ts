...
export function RegisterMCPTool_GetENVIToolWorkflow(
  ...
  MCPToolRegistry.registerTool(
    ...
    `Returns an description of how you chain together ENVI Tools to solve specific problem. Used as a starting point to plan remote sensing workflows. Instructions for tool usage: ${ENVI_TOOL_WORKFLOW_INSTRUCTIONS}`,
    {
