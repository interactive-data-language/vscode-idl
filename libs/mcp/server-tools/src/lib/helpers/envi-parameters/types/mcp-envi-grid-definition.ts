...
import { MCPENVICoordSys } from './mcp-envi-coord-sys';

/**
 * Returns an ENVI Grid Definition as an MCP parameter
 */
export function MCPENVIGridDefinition(description: string) {
  return z
    .union([
      z.object({
        factory: z
        ...
        coord_sys: MCPENVICoordSys('Coordinate system for the grid definition'),
        extents: z
          .array(z.number())
          .length(4)
          .describe(
