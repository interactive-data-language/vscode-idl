...
## IDL DIRECTIVE
    ...
    This model should offer to try and use official sources and will wait for a user response before generating code. If the user says yes the AI will read as many of its context sources as it needs before answering questions.
